            ...
            <div className="w-full justify-evenly">
              ...
              <div className="flex phone1:flex-col">
                <div className="flex flex-col w-full pt-[20px] pb-[0px] tablet1:pt-[80px] tablet1:pb-[20px] desktop1:pt-[40px]">
                  ...
                  <div className="flex flex-col mt-16 gap-[20px] desktop1:gap-[32px] justify-center">
                    <MotionDivLeftToRight>
                      <div className="flex justify-center w-full desktop1:justify-center">
                        <Button
                          className=" bg-green-800 text-white border-[1px] border-green-800 "
                    ...
                    <p className="mt-[16px] font-medium text-paragraph4 font-secondFont text-center text-white leading-[28px]">
                      A opinião dos nossos clientes são <br /> prova de nossa
                      qualidade. Confira! 👇
                    </p>
                    {/* <MotionDivLeftToRight>
                        <div className="flex justify-center w-full desktop1:justify-center">
                  ...
                  <div className="w-full phone2:w-full tablet2:w-auto">
                    ...
                    <MotionDivLeftToRight>
                      <div className="flex justify-center text-center phone1:w-full font-secondFont text-paragraph4 phone3:text-paragraph5 ">
                        <p className="text-white pb-[16px] tablet1:w-[70%] [text-shadow:_1.8px_1.8px_2px_rgb(0_0_0_/_150%)]">
