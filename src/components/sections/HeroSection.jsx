...
import bgHeroVideo from "../../assets/videos/hero/bgHero.mp4";
...
export default function HeroSection() {
  return (
    <div
      className="relative w-full overflow-hidden h-[100vh] font-mainFont"
      id="home"
    >
      <video
        autoPlay
      ...
      <div className="relative z-10 flex items-center w-full h-full bg-black bg-opacity-50">
          ...
          <div className="flex phone1:flex-col desktop1:flex-row mx-auto mb-[38px] phone3:mb-[52px] w-[90%] max-w-[1215px] items-center gap-[20px] tablet2:gap-14 desktop3:gap-20">
            <div className="flex flex-col w-full pt-[120px] pb-[80px]">
              <MotionDivLeftToRight>
                <div className="text-white font-bold leading-[44px] tablet1:leading-[60px] desktop1:leading-[74px] text-center text-title3 phone1:text-title5 phone3:text-title6 tablet1:text-title7 desktop1:text-[72px]">
