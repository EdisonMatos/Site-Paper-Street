        ...
        <MotionDivDownToUp>
          <div className="flex flex-col">
            <div className="flex flex-col items-center justify-center  p-[20px]">
              <div className="w-[215px] h-[215px] mb-[24px] bg-black rounded-full"></div>
              <h3 className="mb-[8px] text-title1 font-bold">Edison Matos</h3>
              <p className="mb-[24px] text-center text-paragraphLight">
                CEO & DIRETOR DE DESENVOLVIMENTO
              </p>
