import bgImg from "../assets/imgs/hero/bgHeroDentista.webp";
import bgImgAbout from "../assets/imgs/about/aboutImgLp.webp";
...
const LpContent = {
  ...
  hero: {
    ...
    textArea: {
      title: (
        <h1>
          Dentista, tenha um site por apenas
      ...
      subtitle: (
        <p>
          Os dentistas que mais estão captando clientes aprenderam como usar a
          internet!
          <br />
  ...
  features: {
    sectionHeader: {
      miniTag: "VANTAGENS",
      title: "Benefícios em ter um site de Dentista ou para o seu Consultório",
    },
    cards: {
      card1: {
        icon: (
  ...
  about: {
    ...
    sectionHeader: {
      miniTag: "ESPECIALISTAS EM SITES PARA DENTISTAS",
      title: "Quem somos?",
    },
    paragraph: (
      <p>
        ...
        dentistas e escritórios a começarem sua jornada na internet, aumentando
  ...
  cta: {
    ...
    sectionHeader: {
      ...
      title: "Dentista, não perca mais tempo!",
