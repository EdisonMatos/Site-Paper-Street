          ...
          <div className="flex flex-col items-center w-full max-w-md space-y-4">
            ...
            >
              <div class="px-6 py-8">
                ...
                <p class="font-semibold">
                  CONTRATADA: PAPER STREET SOFTWARES E MARKETING DIGITAL LTDA
                  ME, CNPJ: 54.143.106/0001-73, contato@paperstreet.com.br,
                  situada no CAM 41, 18 - Hernani Sá - Ilhéus - BA, CEP
                  45656572, neste ato representada por Edison Pinto de Matos,
                  CPF: 032.868.825-85, doravante denominada CONTRATADA.
                </p>
                ...
                <p class="mb-4">
                  ...
                  CONTRATADA à CONTRATANTE, dos seguintes serviços:
                </p>
                ...
                <p class="mb-4">
                  ...
                  ano. Findado o primeiro ano, a posse do domínio será
                  transferida para a CONTRATANTE, que será a responsável pelo
                  custo de registro deste ponto em diante.
                </p>

                <p class="mb-4">
                  Emails Profissionais: A CONTRATADA criará e disponibilizará
                  acesso de até 5 emails profissionais, com a extensão do
                  domínio escolhido pela CONTRATANTE, durante o período que o
                  contrato estiver vigente.
                </p>

                <p class="mb-4">
                  Hospedagem do Website: A CONTRATADA fará a hospedagem do site
                  e email em servidores de terceiros de alta confiabilidade,
                  sendo escolhidas para isso, as maiores empresas do ramo no
                  território nacional. A empresa escolhida para hospedagem
                  ficará a cargo da CONTRATADA.
                </p>

                <p class="mb-4">
                  Manutenção Mensal: Se solicitada, a CONTRATADA realizará, uma
                  vez por mês, atualização no conteúdo do site (troca de textos
                  e imagens) sem custo adicional, com prazo de entrega de até 3
                  dias úteis.
                </p>
                ...
                <p class="mb-4">
                  ...
                  para o desenvolvimento do site e registro do domínio. Em caso
                  de necessidade de edição ou manipulação de imagem ou de
                  logomarca, será necessário um orçamento separado uma vez que
                  este serviço não é da área de Desenvolvimento de Páginas para
                  Internet. A CONTRATADA não se responsabiliza pelas informações
                ...
                <ul class="list-disc ml-8 mb-4">
                  ...
                  <li>
                    ...
                    realizado até a data especificada como vencimento na
                    cláusula 1, por meio de boleto bancário, chave Pix
                    54143106000173 (CNPJ) em nome da CONTRATADA, cartão de
                    crédito ou outra forma de pagamento acordada entre as
                    partes.
                  </li>
                </ul>
                ...
                <ul class="list-disc ml-8 mb-4">
                  <li>
                    <strong>Aceite de modelo:</strong> O site será desenvolvido
                    de acordo com modelo(s) previamente enviado e aprovado pela
                    CONTRATANTE.
                  </li>
                  <li>
                    <strong>Modificações Estruturais:</strong> Caso seja
                    solicitado criação de seção nova, será feita uma avaliação
                    de viabilidade.
                  </li>
                </ul>
                ...
                <ul class="list-decimal ml-8 mb-4">
                  <li>
                    <strong>Vigência:</strong> O presente contrato entra em
                    vigor na data de sua assinatura e tem duração por tempo
                    indeterminado.
                  </li>
                  <li>
                ...
                <p class="mb-4">
                  Fica eleito o foro da comarca de São Bernardo do Campo - SP,
                  com renúncia expressa de qualquer outro, por mais privilegiado
                  que seja, para dirimir quaisquer controvérsias oriundas deste
                  contrato.
                </p>
              </div>
            </div>
