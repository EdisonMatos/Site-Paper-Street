    ...
    >
      ...
      <ol>
        ...
        <li>
          ...
          envio do link para acesso ao site já no domínio escolhido pelo cliente
      ...
      <ol>
        ...
        <li>
          ...
          criação de seção nova, diferente do que foi apresentado, será feita
          uma avaliação de viabilidade, e caso aceita, poderá ser executada sem
          custo, ou mediante orçamento apresentado à CONTRATANTE.
        </li>
      </ol>
      <br />
      ...
      <ol>
        ...
        <li>
          <strong>Oscilações e Instabilidades:</strong> Em caso de site fora do
          ar por tempo superior a 24 horas, a CONTRATANTE pode solicitar
          desconto na mensalidade proporcional ao período que o site ficou
          inacessível, com exceção de situações que possam ocorrer devido a
          fatores extraordinários, como fatores climáticos (tempestades,
          catástrofes e forças naturais).
        </li>
        <li>
      ...
      <ol>
        ...
        <li>
          <strong>Rescisão por Inexecução:</strong> A parte que deixar de
          cumprir qualquer das obrigações aqui previstas poderá ter o contrato
      ...
      <ol>
        <li>
          <strong>Foro:</strong> Fica eleito o foro da comarca de São Bernardo
          do Campo - SP, com renúncia expressa de qualquer outro, por mais
          privilegiado que seja, para dirimir quaisquer controvérsias oriundas
          deste contrato.
        </li>
        <li>
          <strong>Disposições Finais:</strong> Este contrato é firmado em
          caráter irrevogável e irretratável, obrigando as partes e seus
          sucessores a cumprir com suas disposições. Eventuais aditivos a este
          contrato somente terão validade se forem celebrados por escrito e
